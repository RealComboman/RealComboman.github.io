Gauntlet = function() {
  ...
  var cfg = {
    ...
    keys: [
      ...
      { key: Game.Key.Z,  mode: 'down', state: 'playing', action: function()    { this.player.fire(true);          } },
      { key: Game.Key.Z,  mode: 'up',   state: 'playing', action: function()    { this.player.fire(false);         } },
      { key: Game.Key.X, mode: 'up',   state: 'playing', action: function()    { this.player.nuke();              } },
