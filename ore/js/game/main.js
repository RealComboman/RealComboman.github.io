...
Game.selectGem = function(gem) {
	...
	if (Game.gem == null || gem.id !== Game.gem.id) {
		gem.style.backgroundImage += ', url("./ore/images/sprites/gemSelected.gif")';
		Game.gem = gem;
	}
};
...
Game.deselectGem = function() {
	if (Game.gem != null) {
		Game.gem.style.backgroundImage = 'url("./ore/images/sprites/' + Game.gem.value() + '.png")';
		Game.gem = null;   
	}
};
...
Game.pause = function() {
	...
	pause = new Popup({
		type: 'html',
		content: '<h3>Game is paused</h3><br/>',
		buttons: [
			{
				text: 'Resume',
